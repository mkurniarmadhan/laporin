                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password" role="tabpanel">
                                ...
                                <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
                                    ...
                                    <div class="row mb-3">
                                        <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Masukan
                                            ...
                                            <form method="post" action="{{ route('profile.isAdmin', $user) }}"
                                                ...
                                                <div class="col-auto">
                                                    <select class="form-select  form-select-sm d-inline-block"
                                                        ...
                                                        <option value="1" @selected($user->is_admin)>Admin
                                                        </option>
                                                        <option value="0" @selected(!$user->is_admin)>User
                                                        </option>
                                                    </select>
                                                </div>
